...
class _ToolTipWidgetState extends State<CustomToolTip>
  ...
  double _getTooltipWidth() {
    final width = widget.contentWidth ?? MediaQuery.of(context).size.width;
    if (width > widget.screenSize!.width - 20) {
